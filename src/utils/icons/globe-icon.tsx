...
export function NotoGlobeShowingAmericas(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      >
        <stop offset={0.506} stopColor="#17a1f3"></stop>
        <stop offset={0.767} stopColor="#1b7ffa"></stop>
        <stop offset={0.962} stopColor="#1366f0"></stop>
        <stop offset={1} stopColor="#1160ee"></stop>
      </radialGradient>
      <path
        fill="url(#notoGlobeShowingAmericas0)"
      ...
      ></path>
      <radialGradient
        id="notoGlobeShowingAmericas1"
        cx={4.93}
        cy={38.972}
        r={40.299}
        gradientTransform="matrix(.9806 -.1961 .1182 .5911 -4.511 16.902)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0.344} stopColor="#e3dda6"></stop>
        <stop offset={0.996} stopColor="#e3dda6" stopOpacity={0}></stop>
      </radialGradient>
      <path
        fill="url(#notoGlobeShowingAmericas1)"
      ...
      ></path>
      <radialGradient
        id="notoGlobeShowingAmericas2"
        cx={42.188}
        cy={107.573}
        r={31.591}
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0.723} stopColor="#e3dda6"></stop>
        <stop offset={1} stopColor="#e3dda6" stopOpacity={0}></stop>
      </radialGradient>
      <path
        fill="url(#notoGlobeShowingAmericas2)"
      ...
      ></path>
      <radialGradient
        id="notoGlobeShowingAmericas3"
        cx={62.919}
        cy={134.216}
        r={22.682}
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0.403} stopColor="#e3dda6"></stop>
        <stop offset={1} stopColor="#e3dda6" stopOpacity={0}></stop>
      </radialGradient>
      <path
        fill="url(#notoGlobeShowingAmericas3)"
