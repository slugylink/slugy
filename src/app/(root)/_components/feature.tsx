...
const Features = () => {
  return (
    <div className="dark:bg-background mx-auto mt-10 max-w-[80rem] px-2 py-12 text-center sm:mt-0 sm:py-16 md:py-20 lg:py-24">
      {/* Heading */}
      <div className="mb-6 space-y-4 text-2xl font-semibold sm:text-3xl">
            ...
            <Card className="rounded-none border-none bg-transparent p-3 pt-10 shadow-none sm:p-10">
              <div>
                <div className="relative">
                  <div className="absolute inset-x-32 top-6 m-auto aspect-video bg-gradient-to-tr from-yellow-500 via-red-200 to-violet-300 blur-3xl md:inset-x-16" />
                  <div className="absolute inset-0 z-20 rounded-xl [background:radial-gradient(100%_100%_at_28%_-0%,transparent_50%,#FAFAF8_100%)] dark:[background:radial-gradient(100%_100%_at_0%_0%,transparent_0%,#121212_100%)]" />
                  {/* Feature image */}
